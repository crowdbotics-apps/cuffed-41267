"""
Django settings for cuffed_41267 project.
...
ROOT_URLCONF = 'cuffed_41267.urls'
...
WSGI_APPLICATION = 'cuffed_41267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cuffed_41267 API",
    "DESCRIPTION": "API documentation for cuffed_41267 App",
    "VERSION": "v1",
}
